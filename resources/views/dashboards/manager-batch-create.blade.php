            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('manager.batches.store') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="batch_code" class="block mt-1 w-full" type="text" name="batch_code" :value="old('batch_code')" required autofocus placeholder="e.g. BATCH-1-20260701" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="production_date" class="block mt-1 w-full" type="date" name="production_date" :value="old('production_date', now()->toDateString())" required />
                    ...
                    <div class="mt-4">
                        ...
                        <select id="shift" name="shift" required
                            ...
                            <option value="" disabled {{ old('shift') ? '' : 'selected' }}>{{ __('Select a shift') }}</option>
                    ...
                    <div class="mt-4">
                        ...
                        <select id="manufacturing_stage" name="manufacturing_stage" required
                            ...
                            <option value="finishing" {{ old('manufacturing_stage') === 'finishing' ? 'selected' : '' }}>{{ __('Finishing') }}</option>
                        </select>
